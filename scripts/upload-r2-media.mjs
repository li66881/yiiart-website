...
const bucketName = process.env.R2_BUCKET_NAME || "yiiart-media"
const publicDir = path.resolve("public")

if (!accountId || !apiToken || !bucketName) {
  throw new Error("Set CLOUDFLARE_ACCOUNT_ID, CLOUDFLARE_API_TOKEN, and R2_BUCKET_NAME before uploading media.")
}
