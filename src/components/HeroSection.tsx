...
export default function HeroSection({
  ...
  return (
    <section
      className="relative mt-[var(--yiiart-header-offset)] bg-[#fbfaf6] px-3 pb-2 pt-3 sm:px-6 lg:px-10"
      onMouseEnter={() => setHoverPaused(true)}
      onMouseLeave={() => setHoverPaused(false)}
      aria-roledescription="carousel"
      aria-label="Featured YiiArt collections"
    >
      <div className="relative mx-auto w-full max-w-[1600px] overflow-hidden rounded-[22px] bg-[#eceae4]">
