export default {
  ...
  fields: [
    ...
    { name: 'galleryAssets', title: 'Role-aware product gallery', type: 'array',
      of: [{ type: 'artworkGalleryAsset' }]},
    { name: 'presentationOptions', title: 'Same-price presentation options', type: 'array',
      of: [{ type: 'string' }],
      description: 'Only list options already included in the base price.'},
    { name: 'certificateIncluded', title: 'Certificate included', type: 'boolean',
      initialValue: false,
